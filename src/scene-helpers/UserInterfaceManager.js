class UserInterfaceManager extends Phaser.GameObjects.GameObject {
    ...
    */
    createExtremeModeSetting(centerX, centerY) {
        ...
        newButton.setInteractive({useHandCursor: true}).on("pointerdown", () => {
        ...
        // Bottom text
        let descriptionText = this.parentScene.add.text(centerX, centerY, "", this.MENU_TEXT_CONFIG)
            .setOrigin(0.5)
            .setWordWrapWidth(topText.width*2)
            // Setting the text after the word wrap width here to prevent a WebGL warning in the console
            .setText("In extreme mode, you have less health, your mission lasts 10 rooms, and it's game over if you die.")
            ;

        // Put the parts in a column and horizontally center them
        const marginInPx = 8;
