class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.userInterfaceMgr.createMenuButton(halfGameWidth, halfGameHeight, 288, 108, "Play", "playScene", undefined, {}); // An empty object is passed as data here to the Play scene's init() method to make level progression work properly.
